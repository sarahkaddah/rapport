...
argumentation pour C1archi divisé:		C1 est localisée dans le centromère. C2 se trouve dans le péricentromère et serait plus ancienne et moins homogène.
C3/C4 non traités chez pogo, cependant le dimère n'a pas été traité
		
Mes res:\\
-nb de familles, nb de grandes fam\\
-nb de monomères par fam.-> représentation hist\\
-perte en info\\
-répartition de la nouvelle classification -> ACP\\
-sites de fixation
